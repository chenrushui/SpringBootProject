package com.yunque.www.springbootdemo.module.design.builder;

import com.alibaba.fastjson.JSONObject;
import com.yunque.www.springbootdemo.module.design.builder.demo1.Son;
...
public class TestBuild {
    public static void main(String[] args) {
        ...
        Son.Builder builder1 = new Son.Builder();
        Son son = builder1.setAge(11).setHeight(22).setWeight(44).setName("奥迪").create();
        System.out.println(JSONObject.toJSON(son));
